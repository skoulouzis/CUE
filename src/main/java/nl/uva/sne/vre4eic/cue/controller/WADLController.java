...
public class WADLController {
    ...
    public @ResponseBody
    Application generateWadl(HttpServletRequest request, @RequestParam(required = false) String wadl) {
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> entry : handletMethods.entrySet()) {
            ...
            if (bean.getClass().getName().contains("nl.uva.sne.vre4eic.cue.controller")) {
